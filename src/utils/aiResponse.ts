...
const phraseBank: string[] = [
	...
	`Sourdough isn't some new trend. It's actually the oldest kind of leavened bread. According to NPR, the use of wild yeast as a leavening agent goes at least as far back as the ancient Egyptians.`,
	...
	`Not to brag but my sourdough starter is over 60 years old. It's cute if you into baking during the pandemic, but I don't think you understand the commitment it takes to keep a sourdough starter alive for that long.`,
	...
	`Don't you dare put pickles on that. There is a time and a place for a pickle, and this is not it.`,
	`Actually, tomatoes are native to the Americas. According to Wikipedia, "The Mexican Nahuatl word tomatl gave rise to the Spanish word tomate, from which the English word tomato derived."`,
